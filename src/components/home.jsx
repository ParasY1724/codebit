  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="relative w-full h-[70vh] bg-cover bg-center" style={{
        ...
        {/* Navbar Container */}
        <div className="relative w-full bg-white shadow-sm"> {/* Added shadow */}
          <div className='max-w-7xl mx-auto w-full flex justify-between items-center py-4 px-4 md:px-0'> {/* Added padding for mobile */}

            {/* Logo */}
            <div className="text-teal-800 font-bold text-xl">WanderLust Canvas</div> {/* Changed color */}

            {/* Navigation & Auth Buttons */}
            <div className="flex space-x-2 items-center text-gray-800">
              <button className="flex items-center gap-1 font-semibold text-sm px-2 py-1 hover:text-teal-600"> {/* Changed hover color */}
              ...
              <button className="flex items-center gap-1 font-semibold text-sm px-2 py-1 hover:text-teal-600"> {/* Changed hover color */}
                ...
                <button className="flex items-center gap-1 font-semibold bg-gray-100 px-4 py-2 text-sm hover:bg-gray-200 rounded">
                  <LogIn className="w-4 h-4" /> Login
                </button>
                 {/* Updated Sign Up button color */}
                <button className="flex items-center gap-1 font-semibold bg-teal-600 text-white px-4 py-2 text-sm hover:bg-teal-700 rounded">
